    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cdl_state', models.CharField(blank=True, max_length=2)),
                ('cdl_expiry', models.DateField(blank=True, null=True)),
                ('medical_cert_expiry', models.DateField(blank=True, null=True)),
                ('dot_number', models.CharField(blank=True, max_length=20)),
                ('carrier_name', models.CharField(blank=True, max_length=100)),
                ('home_terminal', models.CharField(blank=True, max_length=100)),
